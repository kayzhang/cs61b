...
public class SList {
	...
	// Construct [  6  9  12  ]
	SList lst = new SList();
	lst.tail = new SListNode(12);
	lst.head = new SListNode(6, new SListNode(9, lst.tail));
	lst.size = 3;
	System.out.println("\nThe initial SList should be [  6  9  12  ]: " + lst);

	// Change to [  3  6  9  12  15  ]
	lst.insertFront(3);
	lst.insertEnd(15);
	System.out.println("The SList has been changed to [  3  6  9  12  15  ]: " + lst);
